...
\begin{tabular}{lcc}
  \toprule
  Zona & Alta congestión & Baja congestión \\
  \midrule
  La Paz  & 27 segmentos  & 223 segmentos \\
  El Alto & 10 segmentos  & 240 segmentos \\
  \bottomrule
\end{tabular}
\end{center}

La congestión severa está concentrada en un subconjunto pequeño de
arterias principales: el centro histórico, la Av. Montes y la autopista
La Paz--El Alto para La Paz; la Ceja y la Av. 6 de Marzo para El Alto.
...
\begin{itemize}
  \item El \textbf{cluster de alta congestión} en La Paz agrupa calles del
  ...
  \item La proyección UMAP (Figura~\ref{fig:umap}) revela dos grupos
    claramente separados, confirmando que la diferencia de patrones es
    genuina y no un artefacto del algoritmo.

  \item Los días sintéticos (martes, jueves) producen perfiles coherentes
    con los días reales adyacentes.
\end{itemize}
